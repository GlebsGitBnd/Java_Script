let newsForPage = ["What is Lorem Ipsum?","Lorem Ipsum is simply dummy " +
          ...
          "non-characteristic words etc.","The standard Lorem Ipsum passage, used " +
          ...
          "mollit anim id est laborum.\"","Section 1.10.32 of \"de Finibus Bonorum " +
          "et Malorum\", written by Cicero in 45 BC","Sed ut perspiciatis unde " +
...
let fullPage = document.documentElement;     //привязываем html тег
let counter = 0;
function scrollPage() {
  while (counter < newsForPage.length) {            //останавливаем цикл при окончании новостей
    let rectBottom = fullPage.getBoundingClientRect().bottom;   //привязывает нижнюю границу документа
    if (rectBottom > fullPage.clientHeight + 10) break;   //останавливаем цикл если новости прогрузились ниже клиентского окна
    p1.innerHTML += newsForPage[counter] + "<br>" + "<br>";   //выводим новости
    counter++;
  }
}
window.addEventListener('scroll', scrollPage);  //повторяем цикл при скроле
scrollPage()    //загружаем первые новости